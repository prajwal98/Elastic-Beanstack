...
export default function AcademicSchedule({
  ...
  return (
    ...
    >
      ...
      <path
        className={cls2}
        d="M77.13,61A17.06,17.06,0,1,1,60.09,78h0A17.07,17.07,0,0,1,77.13,61Z"
      />
      <path
        className={cls3}
        d="M77.13,91A12.94,12.94,0,1,0,64.18,78,12.93,12.93,0,0,0,77.13,91Z"
      />
      <path className={cls4} d="M77.14,69.3v10a.65.65,0,0,0,.65.65h5.89" />
    </svg>
  );
}
